# 3st task which does needs secondary leader team
...
f = open('robots_after_3st_task.pckl', 'rb')
...
robots = scheduling_for_single_task(robots, target3)
for x in robots:
    print(x.number, x.role, x.pre_role, x.location)
from routing_present import routing_graph_for_robot_list
routing_graph_for_robot_list(robots)
